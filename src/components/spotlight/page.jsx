    ...
    return (
        <>
            <div className="w-full relative py-12 justify-center h-[500px] overflow-hidden max-[640px]:w-[540px]  max-[540px]:w-full">
                ...
                <div className="absolute w-full max-[1280px]:w-[850px] max-[1280px]:ml-[150px] max-[1080px]:w-[700px]  max-[980px]:w-full max-[980px]:ml-[0px] max-[786px]:w-[600px] max-[640px]:w-[500px] max-[540px]:w-full">
                    <div className="wrapper">
                        ...
                        <div className="flex gap-3 mt-3 max-[1080px]:w-[355px] max-[640px]:w-full">
