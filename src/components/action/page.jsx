        ...
        <div className="w-full bg-[#EEEEEE] py-[75px]">
            <div className="wrapper">
                <div className="w-[63%] mx-auto">
                    <h2 className="text-[36px] font-bold text-[#000] text-center">
                        Get Started
                    </h2>
                    <p className="text-[16px] text-[#1A1A1A] text-center my-[10px]">
                    ...
                    <span className="block pt-[10px]">
                        <button className="bg-[#76B900] py-[12px] px-[15px] text-[18px] font-bold text-[#000] flex mx-auto">
                            Try Now
                        </button>
                    </span>
                </div>
