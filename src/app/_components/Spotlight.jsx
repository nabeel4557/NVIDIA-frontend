...
function Spotlight() {
    return (
        <>
            <div className="w-full relative py-12  justify-center h-[500px] max-[640px]:h-[350px] max-[410px]:h-[400px] overflow-hidden max-[640px]:w-full  max-[540px]:w-full mt-[160px]">
                <video
                ...
                <div className="absolute w-full max-[1280px]:w-[80%] max-[1280px]:ml-[150px] max-[1080px]:w-[700px]  max-[980px]:w-full max-[980px]:ml-[0px] max-[786px]:w-[600px] max-[640px]:w-[90%] max-[640px]:left-[25px] max-[420px]:left-0 max-[540px]:w-full">
