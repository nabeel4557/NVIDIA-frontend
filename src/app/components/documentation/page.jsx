    ...
    return (
        <div className="w-full bg-[#1A1A1A] text-[#EEEEEE] py-[75px]">
            <div className="wrapper">
                ...
                <div className="flex items-center justify-center mt-[30px] max-[1280px]:text-[16px]">
                    <button className="py-[11px] px-[13px] border-[2px] border-[#768900] text-[18px] font-bold max-[1280px]:text-[16px] max-[1280px]:py-[9px] max-[1280px]:px-[11px] max-[1080px]:text-[14px] max-[1080px]:py-[7px] max-[1080px]:px-[10px]">
                        NVIDIA API Docs
                    </button>
                    <button className="flex items-center text-[18px] font-bold py-[11px] px-[13px] gap-2 max-[1280px]:text-[16px] max-[1080px]:text-[14px]">
                        NVIDIA NIM Docs
