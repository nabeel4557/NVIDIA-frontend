                    ...
                    <div className="w-1/4 bg-[#fff] h-[580px] relative pb-[30px] shadow-lg max-[1080px]:w-[300px] max-[786px]:w-[280px] max-[640px]:w-[500px] max-[540px]:w-full">
                        ...
                        <div className="my-[30px] px-[20px]">
                            ...
                            <p className="text-[#1A1A1A] text-[15px]">
                                Experience end-to-end AI solutions through
                                guided hands-on labs for development frameworks,
                                retrieval-augmented generation (RAG)-based
                                chatbots, route optimizations, and more.
                            </p>
                            <h6 className="flex items-center text-[18px] text-[#000] font-bold absolute bottom-[30px] z-10 max-[1280px]:text-[15px]">
                                Learn More
                    ...
                    <div className="w-1/4 bg-[#fff] h-[580px] relative pb-[30px] shadow-lg max-[1080px]:w-[300px] max-[786px]:w-[280px] max-[640px]:w-[500px]  max-[640px]:mt-[30px] max-[540px]:w-full">
                        ...
                        <div className="my-[30px] px-[20px]">
                            ...
                            <p className="text-[#1A1A1A] text-[15px]">
                                ...
                                development, research, and testing plus
                                technical learning resources through the NVIDIA
                                Developer Program.
                            </p>
                            <h6 className="flex items-center text-[18px] text-[#000] font-bold absolute bottom-[30px] z-10 max-[1280px]:text-[15px]">
                                Start Building
